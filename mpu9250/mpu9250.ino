...
void setup()
{
    ...
    if (c == 0x71) // WHO_AM_I should always be 0x68
    {
        ...
        Serial.print("AK8963");
        Serial.println("I AM");  Serial.print(d, HEX);  Serial.print("I Should Be");   Serial.println(0x48, HEX);
        delay(1000);
...
void loop()
{
    ...
    if (!AHRS) {
        ...
        if (delt_t > 500) { // update LCD once per half-second independent of read rate
            ...
            //Serial.print("rt: "); Serial.print((float) sumCount / sum, 2); Serial.println(" Hz");
